...
programs_data = {
    "Восстановление": {
        ...
        "preparation": (
            "⚠️ <b>Важная подготовка к программе</b> ⚠️\n\n"
    ...
    "Гармония движения": {
        "description": (
            "🏃‍♂️ <b>Программа «Гармония движения»</b> 🏃‍♀️\n\n"
        ...
        "preparation": (
            "⚠️ <b>Правила подготовки к программе</b> ⚠️\n\n"
    ...
    "Ресурсный код": {
        ...
        "preparation": (
            "⚠️ <b>Подготовка к программе</b> ⚠️\n\n"
...
async def main():
    ...
    print(f"📡 @{bot.username} готов к работе")
